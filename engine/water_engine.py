def calculate_water_account(
    ...
    if not 0 < application_efficiency <= 1:
        raise ValueError(
            "Application efficiency must be between 0 and 1."
        )
    ...
    if surface_water_m3 < 0:
        raise ValueError(
            "Surface-water contribution cannot be negative."
        )
    ...
    # --------------------------------------------------------
    # 4. Convert water depth to farm volume
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # 5. Surface-water contribution
    # --------------------------------------------------------

    surface_water_m3 = min(
        surface_water_m3,
        gross_volume_m3
    )
...
def compare_scenarios(
    ...
    """
    Compare two irrigation plans
    using the same groundwater fraction.
    """
    ...
    if min(
        ...
        raise ValueError(
            "Scenario inputs cannot be negative."
        )
    ...
    if groundwater_fraction > 1:
        ...
        raise ValueError(
            "Groundwater fraction must be between 0 and 1."
        )
    ...
    return {
        ...
        "baseline_groundwater_m3":
            baseline_groundwater,

        "aquaguard_groundwater_m3":
            aquaguard_groundwater,
